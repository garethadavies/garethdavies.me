	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
        	...
        	<header>
            	...
            	<h2>NTI Birmingham</h2>
            
            	<p class="no-top-margin"><a href="http://www.ntibirmingham.co.uk/training/">http://www.ntibirmingham.co.uk/training/</a></p>
            ...
            <div class="work-ipad">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/ipad_nti_1.jpg" alt="" title="NTI Birmingham website screenshot" /></li>
                        <li><img src="../../img/ipad_nti_2.jpg" alt="" title="NTI Birmingham website screenshot" /></li>
                        <li><img src="../../img/ipad_nti_3.jpg" alt="" title="NTI Birmingham website screenshot" /></li>
                        <li><img src="../../img/ipad_nti_4.jpg" alt="" title="NTI Birmingham website screenshot" /></li>
                    </ul>
