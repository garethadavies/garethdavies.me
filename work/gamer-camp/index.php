	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
			...
			<header>
            	...
            	<p class="no-top-margin"><a href="http://www.gamercamp.co.uk">http://www.gamercamp.co.uk</a></p>
            ...
            <div class="work-iphone">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/iphone_gc_1.jpg" alt="" title="Gamer Camp website screenshot" /></li>
                        <li><img src="../../img/iphone_gc_2.jpg" alt="" title="Gamer Camp website screenshot" /></li>
                        <li><img src="../../img/iphone_gc_3.jpg" alt="" title="Gamer Camp website screenshot" /></li>
                        <li><img src="../../img/iphone_gc_4.jpg" alt="" title="Gamer Camp website screenshot" /></li>
                    </ul>
