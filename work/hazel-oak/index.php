	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
			...
			<header>
            	...
            	<h2>Hazel Oak School</h2>
            
            	<p class="no-top-margin"><a href="http://www.hazel-oak.co.uk">http://www.hazel-oak.co.uk</a></p>
            ...
            <div class="work-laptop">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/laptop_hazel_1.jpg" alt="" title="Hazel Oak School homepage" /></li>
                        <li><img src="../../img/laptop_hazel_2.jpg" alt="" title="Hazel Oak School Headteacher's message" /></li>
                        <li><img src="../../img/laptop_hazel_3.jpg" alt="" title="Hazel Oak School parents page" /></li>
                        <li><img src="../../img/laptop_hazel_4.jpg" alt="" title="Hazel Oak School contact page" /></li>
                    </ul>
