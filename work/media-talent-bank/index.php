	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
			...
			<header>
            	...
            	<h2>Media Talent Bank</h2>
            
           		<p class="no-top-margin"><a href="http://www.mediatalentbank.com">http://www.mediatalentbank.com</a></p>
            ...
            <div class="work-iphone">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/iphone_mtb_1.jpg" alt="" title="Media Talent Bank website screenshot" /></li>
                        <li><img src="../../img/iphone_mtb_2.jpg" alt="" title="Media Talent Bank website screenshot" /></li>
                        <li><img src="../../img/iphone_mtb_3.jpg" alt="" title="Media Talent Bank website screenshot" /></li>
                        <li><img src="../../img/iphone_mtb_4.jpg" alt="" title="Media Talent Bank website screenshot" /></li>
                    </ul>
