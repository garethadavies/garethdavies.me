	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
			...
			<header>
            	...
            	<h2>Fridge Productions</h2>
            
            	<p class="no-top-margin"><a href="http://www.fridgeproductions.co.uk">http://www.fridgeproductions.co.uk</a></p>
            ...
            <div class="work-ipad">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/ipad_fridge_1.jpg" alt="" title="Fridge Productions website screenshot" /></li>
                        <li><img src="../../img/ipad_fridge_2.jpg" alt="" title="Fridge Productions website screenshot" /></li>
                        <li><img src="../../img/ipad_fridge_3.jpg" alt="" title="Fridge Productions website screenshot" /></li>
                        <li><img src="../../img/ipad_fridge_4.jpg" alt="" title="Fridge Productions website screenshot" /></li>
                    </ul>
