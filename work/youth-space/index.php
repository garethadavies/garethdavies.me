	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
			...
			<header>
            	...
            	<p class="no-top-margin"><a href="http://www.youthspace.me">http://www.youthspace.me</a></p>
            ...
            <div class="work-imac">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/imac-youthspace-1.jpg" alt="" title="Youth Space website screenshot" /></li>
                        <li><img src="../../img/imac-youthspace-2.jpg" alt="" title="Youth Space website screenshot" /></li>
                        <li><img src="../../img/imac-youthspace-3.jpg" alt="" title="Youth Space website screenshot" /></li>
                        <li><img src="../../img/imac-youthspace-4.jpg" alt="" title="Youth Space website screenshot" /></li>
                    </ul>
