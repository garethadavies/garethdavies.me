	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
        	...
        	<header>
            	...
            	<p class="no-top-margin"><a href="http://www.little-palm.co.uk">http://www.little-palm.co.uk</a></p>
            ...
            <div class="work-laptop">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/laptop_lp_1.jpg" alt="" title="Little Palm website screenshot" /></li>
                        <li><img src="../../img/laptop_lp_2.jpg" alt="" title="Little Palm website screenshot" /></li>
                        <li><img src="../../img/laptop_lp_3.jpg" alt="" title="Little Palm website screenshot" /></li>
                        <li><img src="../../img/laptop_lp_4.jpg" alt="" title="Little Palm website screenshot" /></li>
                    </ul>
