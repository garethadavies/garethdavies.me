	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
			...
			<header>
            	...
            	<h2>Tales of Creativity</h2>
            
            	<p class="no-top-margin"><a href="http://www.talesofcreativity.co.uk">http://www.talesofcreativity.co.uk</a></p>
            ...
            <div class="work-laptop">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/laptop_toc_1.jpg" alt="" title="Tales of Creativity website screenshot" /></li>
                        <li><img src="../../img/laptop_toc_2.jpg" alt="" title="Tales of Creativity website screenshot" /></li>
                        <li><img src="../../img/laptop_toc_3.jpg" alt="" title="Tales of Creativity website screenshot" /></li>
                        <li><img src="../../img/laptop_toc_4.jpg" alt="" title="Tales of Creativity website screenshot" /></li>
                    </ul>
