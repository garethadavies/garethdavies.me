	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
			...
			<header>
            	...
            	<p class="no-top-margin"><a href="http://www.inspirationbank.com">http://www.inspirationbank.com</a></p>
            ...
            <div class="work-imac">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/imac_ib_1.jpg" alt="" title="Inspiration Bank website screenshot" /></li>
                        <li><img src="../../img/imac_ib_2.jpg" alt="" title="Inspiration Bank website screenshot" /></li>
                        <li><img src="../../img/imac_ib_3.jpg" alt="" title="Inspiration Bank website screenshot" /></li>
                        <li><img src="../../img/imac_ib_4.jpg" alt="" title="Inspiration Bank website screenshot" /></li>
                    </ul>
