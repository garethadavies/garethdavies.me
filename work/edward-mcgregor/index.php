	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
			...
			<header>
            	...
            	<h2>Edward McGregor</h2>
            
            	<p class="no-top-margin"><a href="http://www.edwardmcgregor.com">http://www.edwardmcgregor.com</a></p>
            ...
            <div class="work-imac">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/imac_ed_1.jpg" alt="" title="Edward McGregor homepage" /></li>
                        <li><img src="../../img/imac_ed_2.jpg" alt="" title="Edward McGregor Twitter feed page" /></li>
                        <li><img src="../../img/imac_ed_3.jpg" alt="" title="Edward McGregor contact page" /></li>
                    </ul>
