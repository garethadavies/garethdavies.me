	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
        	...
        	<header>
            	...
            	<p class="no-top-margin"><a href="http://www.v-net.tv">http://www.v-net.tv</a></p>
            ...
            <div class="work-laptop">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/laptop_videonet_1.jpg" alt="" title="Videonet website screenshot" /></li>
                        <li><img src="../../img/laptop_videonet_2.jpg" alt="" title="Videonet website screenshot" /></li>
                        <li><img src="../../img/laptop_videonet_3.jpg" alt="" title="Videonet website screenshot" /></li>
                        <li><img src="../../img/laptop_videonet_4.jpg" alt="" title="Videonet website screenshot" /></li>
                    </ul>
