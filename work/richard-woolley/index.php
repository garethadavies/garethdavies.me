	...
	<?php echo $response_header; ?>
        ...
        <?php echo $response_nav; ?>
			...
			<header>
            	...
            	<h2>Richard Woolley</h2>
            
           	 	<p class="no-top-margin"><a href="http://www.richardwoolley.com">http://www.richardwoolley.com</a></p>
            ...
            <div class="work-laptop">
            	...
            	<div class="flexslider">
                    ...
                    <ul class="slides">
                        <li><img src="../../img/laptop_woolley_1.jpg" alt="" title="Richard Woolley website screenshot" /></li>
                        <li><img src="../../img/laptop_woolley_2.jpg" alt="" title="Richard Woolley website screenshot" /></li>
                        <li><img src="../../img/laptop_woolley_3.jpg" alt="" title="Richard Woolley website screenshot" /></li>
                        <li><img src="../../img/laptop_woolley_4.jpg" alt="" title="Richard Woolley website screenshot" /></li>
                    </ul>
